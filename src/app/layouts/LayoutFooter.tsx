  ...
  return (
    <>
      ...
      <div className='w-full bg-gray-700 min-h-[50px] flex flex-col md:flex-row items-center justify-around fixed bottom-0'>
        ...
        <div>
          <Link to='https://www.linkedin.com/in/gabriel-alves-73860a1ab/' className='text-white font-bold hover:underline' target='_blank' aria-label='see Author'>see Author</Link>
        </div>
      </div>
    </>
  )
